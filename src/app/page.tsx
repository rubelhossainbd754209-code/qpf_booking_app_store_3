        ...
        <div className="container flex h-16 sm:h-20 md:h-24 items-center justify-between px-3 sm:px-4 md:px-6">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-xs sm:text-base font-semibold text-gray-900">Shop 03</span>
              <span className="text-[10px] sm:text-sm text-gray-500 truncate max-w-[120px] sm:max-w-none">Quick Phone Fix N More Germantown,Chelten Ave</span>
            </div>
          </div>
        </div>
      </header>
